...
class ConsumableUsers {
  constructor() {
    ...
    this.empty = false //added this line
  ...
  get nextUser() {
    ...
    this.empty = true //added this line
    return void 0;
  }
  get anyLeft() {
    return this.empty; //changed this line
    //above changes were found online...is this broken? or did I miss something in the instructions?
