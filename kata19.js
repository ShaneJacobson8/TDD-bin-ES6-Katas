...
describe('Rest parameters with destructuring', () => {
  ...
  });//this caused the rest of the array to be filled in with the contents of theEnd
  it('`apply` made simple, even for constructors', () => {
    const theDate = [2015, 1, 1];
    const date = new Date(...theDate);//added rest syntax to include contents assigned to theDate
