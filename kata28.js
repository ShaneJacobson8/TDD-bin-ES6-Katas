...
describe('Inside a class`s constructor `super()` can be used', () => {
  it('`extend` a class and use `super()` to call the parent constructor', () => {
    ...
    class B extends A{//added extends A to access inheritence
      constructor() {
        super() //added super() to grab parent constructor
        this.levels++;
      }
    }
  ...
  it('it is important where you place your `super()` call!', () => {
    ...
    class B extends A {
      inc() {
        ...
        this.countUp = 2;
        super.inc();//calling super will override any previously set value in child
        return this.countUp;
      }
    }
