...
describe('Pass a value to a generator', () => {
  ...
  it('pass a value to the iterator', function() {
    function* generatorFunction(param) { //define param here first
      yield 1;
      yield param;
    }
    var iterator = generatorFunction(2); //pass a value to the function call
  ...
  it('a value passed to the 1st `next()` call is ignored', function() {
    function* generatorFunction() {
      yield 1;
      yield 2;//needs 2nd yield to provide value to second .next()
